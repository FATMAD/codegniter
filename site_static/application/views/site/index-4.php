            ...
            <div class="row">
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="about-history-content">
                        <img src="assets/img/about/about-details-2.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="about-history-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                        <div class="single-footer-widget instafeed-widget">
                            <h3>Customer Service</h3>
                            <ul>
                                <li><a href="#"><img src="assets/img/instafeed/1.jpg" alt=""></a></li>
                                <li><a href="#"><img src="assets/img/instafeed/2.jpg" alt=""></a></li>
                                <li><a href="#"><img src="assets/img/instafeed/3.jpg" alt=""></a></li>
                                <li><a href="#"><img src="assets/img/instafeed/4.jpg" alt=""></a></li>
                                <li><a href="#"><img src="assets/img/instafeed/5.jpg" alt=""></a></li>
                                <li><a href="#"><img src="assets/img/instafeed/6.jpg" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
